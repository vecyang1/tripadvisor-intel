...
def main() -> int:
    ...
    # --- search ---
    p_search = subparsers.add_parser("search", help="Search TripAdvisor places by destination or name")
    ...
    # --- place ---
    p_place = subparsers.add_parser("place", help="Get complete place details, subratings, and reviews")
    ...
    # --- reason ---
    p_reason = subparsers.add_parser("reason", help="Generate actionable AI travel intelligence dossier")
    ...
    # --- reviews ---
    p_rev = subparsers.add_parser("reviews", help="Fetch paginated reviews with SQLite persistence")
    ...
    # --- doctor ---
    p_doc = subparsers.add_parser("doctor", help="Run system and connectivity diagnostics")
    ...
    # --- cache ---
    p_cache = subparsers.add_parser("cache", help="Manage SQLite cache")
